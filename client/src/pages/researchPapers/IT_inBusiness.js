    ...
    return (
        <div className="paper"> {/* Main container for the paper content */}
            <div className="page-break-before: always"> {/* Page break for printing */}
                <h1 className="APA_Title">{data.title}</h1> {/* Title of the paper */}
                <p className='text-body-secondary'><strong>Author:</strong> {data.author}</p> {/* Author name */}
                <p className='text-body-secondary'><strong>Date of Completion:</strong> {data.date_of_completion}</p> {/* Completion date */}
            </div>
...
export default IT_Business; // Export the IT_Business component
